...
ft_isprint.c ft_memchr.c ft_memcmp.c ft_memcpy.c ft_memmove.c ft memset.c\
...
ft_strjoin.c ft_strtrim.c ft_itoa.c ft_strmapi.c ft _striteri.c ft_putchar_fd.c\
